...
def _project_root() -> Path:
    """
    Resolves project root assuming this file lives at: <root>/src/utils/config_loader.py
    """
...
def load_config(config_path: str | Path = "src/config/transport_provider.yaml") -> ProviderConfig:
    root = _project_root()
